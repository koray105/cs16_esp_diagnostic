...
- **Interactive OpenGL GUI**:
  ...
  - iibe_config.ini üzerinden kalıcı yapılandırma (INI Serialization)
...
Proje dizininde yer alan uild_internal.bat dosyasını çalıştırabilir veya terminal üzerinden manuel olarak derleyebilirsiniz:
